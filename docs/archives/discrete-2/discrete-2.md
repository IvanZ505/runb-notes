...
> [Discrete 1 Notes on Sets](../discrete-1/discrete-1.md#Sets)
...
P(A1 ∪ A2 ∪ · · ·) = P(A1) + P(A2) + · · *([Addition Rule](../cog-decision/probability.md#addition-rule))*
...
- You know you are using [**Bayes Theorem**](../cog-decision/probability.md#bayes-theorem), if you are given P(B|A) and are asked to find P(A|B).
