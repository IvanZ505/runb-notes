...
- This class overlaps with machine learning, statistics, artificial intelligence, databases but more stress on:
	...
	- **Algorithms** - Check out [DS notes](../data-structures/cs112.md)
	- **Computing Architectures**
	- Automation for handling **large data**


## [Frequent Itemsets](1-frequent-itemset.md)
## [MapReduce](2-mapreduce.md)

## [LSH](3-lsh.md)

## [Clustering](4-clustering.md)

## [Dimensionality Reduction](5-dimensionality-reduction.md)
