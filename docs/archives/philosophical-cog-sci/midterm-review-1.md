...
> For additional notes, check out notes from [Intro](../../archives/cog-sci/2-history-of-the-mind.md#behaviorism) and [PhiloCS](1-what-is-cog-sci.md#behaviorism).
...
- Think [Turing machine](../../archives/discrete-1/discrete-1.md#turing-machine).
...
- **They are [multiply realizable](../../archives/cog-sci/1-foundations-of-cog-sci.md#multiple-realizability-thesis)**.
...
> Previous notes on the mental architecture debate: [Intro](../../archives/cog-sci/4-artificial-minds.md#the-great-debate).
